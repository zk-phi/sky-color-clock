...
(defun sky-color-clock--decide-moonphase (time)
  (let* ((time-in-days (/ (float-time time) 60 60 24))
    ...
    (cond ((<= phase  1.84) "new_moon")
          ((<= phase  5.53) "waxing_crescent_moon")
          ((<= phase  9.22) "first_quarter_moon")
          ((<= phase 12.91) "waxing_gibbous_moon")
          ((<= phase 16.61) "full_moon")
          ((<= phase 20.30) "waning_gibbous_moon")
          ((<= phase 23.99) "last_quarter_moon")
          ((<= phase 27.68) "waning_crescent_moon")
          (t                "new_moon"))))

(defun sky-color-clock--emoji-moonphase (time)
  (let ((phase (sky-color-clock--decide-moonphase time)))
    (cond ((eq phase "new_moon") "🌑")
          ((eq phase "waning_crescent_moon") "🌒")
          ((eq phase "first_quarter_moon") "🌓")
          ((eq phase "waxing_gibbous_moon") "🌔")
          ((eq phase "full_moon") "🌕")
          ((eq phase "waning_gibbous_moon") "🌖")
          ((eq phase "last_quarter_moon") "🌗")
          ((eq phase "waning_crescent_moon") "🌘")
          (t                "🌑"))))
